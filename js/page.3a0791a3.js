parcelRequire = function(e, r, t, n) {
		...
		! function(e, n) {
			...
			var e, n = function() {
				...
				function Z(t) {
					var e = !!t && "length" in t && t.length,
						n = r.type(t);
					return "function" != n && !F(t) && ("array" == n || 0 === e || "number" ==
						typeof e && e > 0 && e - 1 in t)
				}

				function z(t) {
					return t.replace(/::/g, "/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2")
						.replace(/([a-z\d])([A-Z])/g, "$1_$2").replace(/_/g, "-").toLowerCase()
				}
				...
				function I(t) {
					return "children" in t ? l.call(t.children) : r.map(t.childNodes, function(
						t) {
				...
				function J(t) {
					try {
						return t ? "true" == t || "false" != t && ("null" == t ? null : +t +
							"" == t ? +t : /^[\[\{]/.test(t) ? r.parseJSON(t) : t) : t
					} catch (e) {
						return t
					}
				}
				return O.matches = function(t, e) {
						...
						var r, i = t.parentNode,
							o = !i;
						return o && (i = P).appendChild(t), r = ~O.qsa(i, e).indexOf(t), o && P
							.removeChild(t), r
					}, o = function(t) {
						...
						var o, a, s;
						return v.test(t) && (o = r(f.createElement(RegExp.$1))), o || (t
						...
						if (!t) return O.Z();
						if ("string" == typeof t)
							if ("<" == (t = t.trim())[0] && m.test(t)) i = O.fragment(t, RegExp
								.$1, n), t = null;
							else {
						...
						return "boolean" == typeof t && (r = t, t = i.shift()), i.forEach(
							function(i) {
								! function t(r, i, o) {
									for (n in i) o && (R(i[n]) || D(i[n])) ? (R(i[n]) && !R(
											r[n]) && (r[n] = {}), D(i[n]) && !D(r[n]) &&
										(r[n] = []), t(r[n], i[n], o)) : i[n] !== e && (
										r[n] = i[n])
								}(t, i, r)
							}), t
					}, O.qsa = function(t, e) {
						var n, r = "#" == e[0],
							...
							o = r || i ? e.slice(1) : e,
							a = S.test(o);
						return t.getElementById && a && r ? (n = t.getElementById(o)) ? [n] :
						[] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : l
							.call(a && !r && t.getElementsByClassName ? i ? t
								.getElementsByClassName(o) : t.getElementsByTagName(e) : t
								.querySelectorAll(e))
						...
						for (; e && (e = e.parentNode);)
							if (e === t) return !0;
						return !1
					}, r.type = L, r.isFunction = $, r.isWindow = F, r.isArray = D, r
					.isPlainObject = R, r.isEmptyObject = function(t) {
						var e;
						for (e in t) return !1;
						return !0
						...
						var e = Number(t),
							n = typeof t;
						return null != t && "boolean" != n && ("string" != n || t.length) && !
							isNaN(e) && isFinite(e) || !1
					}, r.inArray = function(t, e, n) {
						return s.indexOf.call(e, t, n)
					}, r.camelCase = o, r.trim = function(t) {
						return null == t ? "" : String.prototype.trim.call(t)
					}, r.uuid = 0, r.support = {}, r.expr = {}, r.noop = function() {}, r.map =
					function(t, e) {
						var n, i, o, a, s = [];
						if (Z(t))
						...
						return c.call(t, e)
					}, t.JSON && (r.parseJSON = JSON.parse), r.each(
						...
						concat: function() {
							var t, e, n = [];
							for (t = 0; t < arguments.length; t++) e = arguments[t], n[t] =
								O.isZ(e) ? e.toArray() : e;
						...
						ready: function(t) {
							return w.test(f.readyState) && f.body ? t(r) : f
								.addEventListener("DOMContentLoaded", function() {
									t(r)
								}, !1), this
						},
						get: function(t) {
							return t === e ? l.call(this) : this[t >= 0 ? t : t + this
								.length]
						},
						toArray: function() {
							return this.get()
						...
						remove: function() {
							return this.each(function() {
								null != this.parentNode && this.parentNode
									.removeChild(this)
							})
						},
						each: function(t) {
						...
						not: function(t) {
							...
							if ($(t) && t.call !== e) this.each(function(e) {
								...
								var i = "string" == typeof t ? this.filter(t) : Z(t) && $(t
									.item) ? l.call(t) : r(t);
						...
						has: function(t) {
							return this.filter(function() {
								return M(t) ? r.contains(this, t) : r(this).find(t)
									.size()
							})
						},
						eq: function(t) {
						...
						closest: function(t, e) {
							...
							return this.each(function(r, o) {
								for (; o && !(i ? i.indexOf(o) >= 0 : O.matches(o,
										t));) o = o !== e && !k(o) && o.parentNode;
								o && n.indexOf(o) < 0 && n.push(o)
							}), r(n)
						},
						parents: function(t) {
							for (var e = [], n = this; n.length > 0;) n = r.map(n, function(
								t) {
						...
						contents: function() {
							return this.map(function() {
								return this.contentDocument || l.call(this
									.childNodes)
							})
						},
						siblings: function(t) {
						...
						show: function() {
							return this.each(function() {
								var t, e, n;
								"none" == this.style.display && (this.style
									.display = ""), "none" == getComputedStyle(
									this, "").getPropertyValue("display") && (
									this.style.display = (t = this.nodeName, h[
										t] || (e = f.createElement(t), f
										.body.appendChild(e), n =
										getComputedStyle(e, "")
						...
						wrap: function(t) {
							...
							return this.each(function(o) {
								r(this).wrapAll(e ? t.call(this, o) : i ? n
									.cloneNode(!0) : n)
							})
						},
						wrapAll: function(t) {
						...
						attr: function(t, r) {
							var i;
							return "string" != typeof t || 1 in arguments ? this.each(
								function(e) {
									if (1 === this.nodeType)
										if (M(t))
											for (n in t) U(this, n, t[n]);
										else U(this, t, B(this, r, e, this.getAttribute(
											t)))
								}) : 0 in this && 1 == this[0].nodeType && null != (i =
								this[0].getAttribute(t)) ? i : e
						},
						removeAttr: function(t) {
							return this.each(function() {
								1 === this.nodeType && t.split(" ").forEach(
									function(t) {
										U(this, t)
									}, this)
							})
						...
						val: function(t) {
							return 0 in arguments ? (null == t && (t = ""), this.each(
								function(e) {
									this.value = B(this, t, e, this.value)
								})) : this[0] && (this[0].multiple ? r(this[0]).find(
						...
						offset: function(e) {
							if (e) return this.each(function(t) {
								...
								"static" == n.css("position") && (a.position =
									"relative"), n.css(a)
							});
							if (!this.length) return null;
							if (f.documentElement !== this[0] && !r.contains(f
									.documentElement, this[0])) return {
								top: 0,
								left: 0
							};
							...
							if (arguments.length < 2) {
								...
								if (D(t)) {
									...
									return r.each(t, function(t, e) {
										a[e] = i.style[o(e)] || s.getPropertyValue(
											e)
									}), a
								}
							}
							var u = "";
							if ("string" == L(t)) e || 0 === e ? u = z(t) + ":" + H(t, e) :
								this.each(function() {
									this.style.removeProperty(z(t))
								});
							else
								for (n in t) t[n] || 0 === t[n] ? u += z(n) + ":" + H(n, t[
						...
						index: function(t) {
							return t ? this.indexOf(r(t)[0]) : this.parent().children()
								.indexOf(this[0])
						},
						hasClass: function(t) {
						...
						addClass: function(t) {
							return t ? this.each(function(e) {
								if ("className" in this) {
									i = [];
									var n = X(this);
									B(this, t, e, n).split(/\s+/g).forEach(function(
										t) {
										r(this).hasClass(t) || i.push(t)
									}, this), i.length && X(this, n + (n ? " " :
										"") + i.join(" "))
								}
							}) : this
						},
						removeClass: function(t) {
							return this.each(function(n) {
								if ("className" in this) {
									...
									i = X(this), B(this, t, n, i).split(/\s+/g)
										.forEach(function(t) {
											i = i.replace(q(t), " ")
										}), X(this, i.trim())
								}
						...
						toggleClass: function(t, n) {
							return t ? this.each(function(i) {
								var o = r(this);
								B(this, t, i, X(this)).split(/\s+/g).forEach(
									function(t) {
										(n === e ? !o.hasClass(t) : n) ? o
											.addClass(t): o.removeClass(t)
									})
							}) : this
						},
						scrollTop: function(t) {
							if (this.length) {
								...
								return t === e ? n ? this[0].scrollTop : this[0]
									.pageYOffset : this.each(n ? function() {
										this.scrollTop = t
									} : function() {
						...
						scrollLeft: function(t) {
							if (this.length) {
								...
								return t === e ? n ? this[0].scrollLeft : this[0]
									.pageXOffset : this.each(n ? function() {
										this.scrollLeft = t
									} : function() {
						...
						position: function() {
							if (this.length) {
								...
								return n.top -= parseFloat(r(t).css("margin-top")) || 0, n
									.left -= parseFloat(r(t).css("margin-left")) || 0, i
									.top += parseFloat(r(e[0]).css("border-top-width")) ||
									0, i.left += parseFloat(r(e[0]).css(
										"border-left-width")) || 0, {
										top: n.top - i.top,
										left: n.left - i.left
									}
						...
						offsetParent: function() {
							return this.map(function() {
								for (var t = this.offsetParent || f.body; t && !y
									.test(t.nodeName) && "static" == r(t).css(
						...
						r.fn[t] = function(i) {
							var o, a = this[0];
							return i === e ? F(a) ? a["inner" + n] : k(a) ? a
								.documentElement["scroll" + n] : (o = this.offset()) &&
						...
						r.fn[n] = function() {
								var n, a, s = r.map(arguments, function(t) {
										var i = [];
										return "array" == (n = L(t)) ? (t.forEach(
												function(t) {
													return t.nodeType !== e ? i
														.push(t) : r.zepto.isZ(t) ?
														i = i.concat(t.get()) :
														void(i = i.concat(O
															.fragment(t)))
												}), i) : "object" == n || null == t ?
								...
								return s.length < 1 ? this : this.each(function(e, n) {
									a = o ? n : n.parentNode, n = 0 == i ? n
										.nextSibling : 1 == i ? n.firstChild : 2 ==
										i ? n : null;
					...
					}), O.Z.prototype = V.prototype = r.fn, O.uniq = a, O.deserializeValue = J,
					r.zepto = O, r
			}();
			return t.Zepto = n, void 0 === t.$ && (t.$ = n),
				function(e) {
					...
					function p(t, e, n, r) {
						...
						return (s[h(t)] || []).filter(function(t) {
							return t && (!e.e || t.e == e.e) && (!e.ns || i.test(t.ns)) && (
								!n || h(t.fn) === h(n)) && (!r || t.sel == r)
						})
					}
						...
						r.split(/\s/).forEach(function(r) {
							...
							s.proxy = function(e) {
									if (!(e = T(e)).isImmediatePropagationStopped()) {
										e.data = o;
										var r = l.apply(t, e._args == n ? [e] : [e].concat(e
											._args));
										return !1 === r && (e.preventDefault(), e
											.stopPropagation()), r
									}
								}, s.i = p.length, p.push(s), "addEventListener" in t && t
								.addEventListener(v(s.e), s.proxy, m(s, c))
						})
					}
					...
					function y(t, e, n, r, i) {
						...
						(e || "").split(/\s/).forEach(function(e) {
							p(t, e, n, r).forEach(function(e) {
								delete s[o][e.i], "removeEventListener" in t && t
									.removeEventListener(v(e.e), e.proxy, m(e, i))
							})
						})
					}
					u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents", e.event = {
						...
						if (o(t)) {
							var s = function() {
								return t.apply(n, r ? r.concat(i.call(arguments)) :
									arguments)
							};
							return s._zid = h(t), s
						}
						if (a(n)) return r ? (r.unshift(t[n], t), e.proxy.apply(null, r)) : e
							.proxy(t[n], t);
					...
					function T(t, r) {
						...
						}), t.timeStamp || (t.timeStamp = Date.now()), (r
							.defaultPrevented !== n ? r.defaultPrevented : "returnValue" in
							r ? !1 === r.returnValue : r.getPreventDefault && r
							.getPreventDefault()) && (t.isDefaultPrevented = x)), t
					}
					...
					e.fn.delegate = function(t, e, n) {
							...
							return t && !a(t) ? (e.each(t, function(t, e) {
								h.on(t, r, s, e, c)
							}), h) : (a(r) || o(u) || !1 === u || (u = s, s = r, r = n), u !==
								n && !1 !== s || (u = s, s = n), !1 === u && (u = b), h.each(
									function(n, o) {
										c && (l = function(t) {
											return y(o, t.type, u), u.apply(this,
												arguments)
										}), r && (f = function(t) {
							...
							return (t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))._args = n,
								this.each(function() {
									t.type in l && "function" == typeof this[t.type] ? this[t
											.type]() : "dispatchEvent" in this ? this
										.dispatchEvent(t) : e(this).triggerHandler(t, n)
								})
						}, e.fn.triggerHandler = function(t, n) {
							var r, i;
							return this.each(function(o, s) {
								(r = w(a(t) ? e.Event(t) : t))._args = n, r.target = s, e
									.each(p(s, t.type || t), function(t, e) {
										if (i = e.proxy(r), r
											.isImmediatePropagationStopped()) return !1
									})
							}), i
						},
				...
				function(e) {
					...
					function d(t, e) {
						var n = e.context;
						if (!1 === e.beforeSend.call(n, t, e) || !1 === p(e, n, "ajaxBeforeSend", [
								t, e
							])) return !1;
						p(e, n, "ajaxSend", [t, e])
					}
					...
					function v(t, e, n, r, i) {
						var o = r.context;
						r.error.call(o, n, e, t), i && i.rejectWith(o, [n, e, t]), p(r, o,
							"ajaxError", [n, r, t || e]), g(e, n, r)
					}
					...
					function b(t, n, r, i) {
						return e.isFunction(n) && (i = r, r = n, n = void 0), e.isFunction(r) || (
							i = r, r = void 0), {
							url: t,
							data: n,
							success: r,
					...
					h.href = t.location.href, e.active = 0, e.ajaxJSONP = function(n, r) {
						...
						return r && r.promise(p), e(l).on("load error", function(i, o) {
							clearTimeout(s), e(l).off().remove(), "error" != i.type &&
								a ? m(a[0], p, n, r) : v(null, o || "error", p, n, r),
								t[c] = f, a && e.isFunction(f) && f(a[0]), f = a =
								void 0
						}), !1 === d(p, n) ? (h("abort"), p) : (t[c] = function() {
								a = arguments
							}, l.src = n.url.replace(/\?(.+)=\?/, "?$1=" + c), o.head
							.appendChild(l), n.timeout > 0 && (s = setTimeout(function() {
								h("timeout")
							}, n.timeout)), p)
					}, e.ajaxSettings = {
						type: "GET",
						...
						}(b), b.crossDomain || ((a = o.createElement("a")).href = b.url, a
								.href = a.href, b.crossDomain = h.protocol + "//" + h.host != a
								.protocol + "//" + a.host), b.url || (b.url = t.location
								.toString()), (g = b.url.indexOf("#")) > -1 && (b.url = b.url
								.slice(0, g)),
							function(t) {
								t.processData && t.data && "string" != e.type(t.data) && (t
										.data = e.param(t.data, t.traditional)), !t.data || t
									.type && "GET" != t.type.toUpperCase() && "jsonp" != t
									.dataType || (t.url = x(t.url, t.data), t.data = void 0)
							}(b);
						var j = b.dataType,
							T = /\?.+=\?/.test(b.url);
						if (T && (j = "jsonp"), !1 !== b.cache && (i && !0 === i.cache ||
								"script" != j && "jsonp" != j) || (b.url = x(b.url, "_=" + Date
								.now())), "jsonp" == j) return T || (b.url = x(b.url, b.jsonp ?
								b.jsonp + "=?" : !1 === b.jsonp ? "" : "callback=?")), e
							.ajaxJSONP(b, E);
						var w, S = b.accepts[j],
							C = {},
							N = function(t, e) {
						...
						if (E && E.promise(P), b.crossDomain || N("X-Requested-With",
								"XMLHttpRequest"), N("Accept", S || "*/*"), (S = b.mimeType ||
						...
						if (P.setRequestHeader = N, P.onreadystatechange = function() {
								if (4 == P.readyState) {
									...
									var t, n = !1;
									if (P.status >= 200 && P.status < 300 || 304 == P.status ||
										0 == P.status && "file:" == O) {
										if (j = j || ((r = b.mimeType || P.getResponseHeader(
											...
											try {
												t = function(t, e, n) {
													...
													}(t, j, b), "script" == j ? (0, eval)(t) :
													"xml" == j ? t = P.responseXML : "json" ==
													j && (t = f.test(t) ? null : e.parseJSON(t))
											} catch (i) {
												n = i
											}
										...
										m(t, P, b, E)
									} else v(P.statusText || null, P.status ? "error" : "abort",
										P, b, E)
								}
								var r
						...
						return b.timeout > 0 && (w = setTimeout(function() {
							P.onreadystatechange = y, P.abort(), v(null, "timeout",
								P, b, E)
					...
					e.param = function(t, n) {
						...
						return r.add = function(t, n) {
								e.isFunction(n) && (n = n()), null == n && (n = ""), this.push(
									E(t) + "=" + E(n))
							},
							function t(n, r, i, o) {
								var a, s = e.isArray(r),
					...
					return this.serializeArray().forEach(function(e) {
						t.push(encodeURIComponent(e.name) + "=" + encodeURIComponent(e
							.value))
					}), t.join("&")
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["希望能成为有趣的人", "愿你三冬暖","愿你春不寒", "你好，请多指教", 
					 "平凡的日常也会有奇迹发生", 
					 "欢迎您", "祝您好运！", "我一直在！", "愿你一直有人陪！"
				],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
		...
		delete Object.prototype.document, delete Object.prototype.location, window.requestAnimFrame =
			window.requestAnimationFrame || window.webkitRequestAnimationFrame || window
			...
			.msRequestAnimationFrame || function(t) {
				...
				function w() {
					u(), ++c > 150 && c % 8 == 0 && (a.fillStyle = "rgba(0,0,0,.04)", a.fillRect(-
						3 * n, -3 * n, 6 * n, 6 * n)), f(.025)
				}
				...
				for (var m, s, g, b, v = 2e4; v--;) m = void 0, s = void 0, g = void 0, b = void 0,
					d.push({
						x: h(-o.width, o.width),
						y: h(-o.height, o.height),
						size: 1.2,
						color: (m = h(120, 255), s = h(120, 255), g = h(120, 255), b = h(30,
							100) / 100, "rgba(" + m + "," + s + "," + g + "," + b + ")")
					});
				! function() {
					for (var t = d.length; t--;) {
						var e = d[t];
						r.beginPath(), r.arc(e.x, e.y, e.size, 0, 2 * Math.PI, !0), r.fillStyle = e
							.color, r.closePath(), r.fill()
					}
				}();
				var p = l;
				a.translate(p, 0),
					function t() {
						...
						i.width = t = i.offsetWidth, i.height = e = i.offsetHeight, a.fillStyle =
							"rgba(21,21,21,1)", a.fillRect(0, 0, t, e)
					}
			}), window.onscroll = function() {
				t(window).scrollTop() > .6 * t(window).height() ? t(".background").addClass("fixed") :
